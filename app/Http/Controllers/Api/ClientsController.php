...
class ClientsController extends ApiController {
    ...
    public function add_client(Request $request)
    {
        ...
        else
        {
            ...
            $result = $this->common_model->fetchData($this->tableObj->tableClient,$conditions);
            ...
            else
            {
                ...
                $insertdata = $this->common_model->insert_data_get_id($this->tableObj->tableClient,$client_data);
                if($insertdata > 0){
                    /* Send Email */
