...
(function ($, window, document, undefined) {
    ...
    Owl.Workers = [{
        ...
        , run: function () {
            var clones = []
                , items = this._items
                , settings = this.settings, // TODO: Should be computed from number of min width items in stage
...
(function ($, window, document, undefined) {
    ...
    Navigation.Defaults = {
        nav: false
        , navText: [
			'<span aria-label="' + 'Previous' + '"><img src="images/arrowprev.gif"></span>'
			, '<span aria-label="' + 'Next' + '"><img src="images/arrownxt.gif"></span>'
		]
        , navSpeed: false
