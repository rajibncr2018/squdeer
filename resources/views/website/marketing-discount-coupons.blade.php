...
<div class="leftpan">
   <div class="left-menu">
      <ul>
        ...
        <li><a href="{{ url('marketing-discount-coupons') }}" class="active"> Discount Coupons</a> </li>
...
<div class="rightpan">
   <div class="discount-box">
      <a class="btn cus-discount-btn" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus" aria-hidden="true"></i>  Discount Coupon </a>
      <h2>Discount Coupons</h2>
      <p>Create a "Discount Coupon" to offer a discounted price on any service to your customers. Your clients can input this discount coupon code during the booking process. You can promote these "Discount Coupons" on Facebook, Twitter, or via Email. If you want to offer an "Add-On" service instead of a discounted price, just create "Offer Coupon". </p>
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group">
                           <div class="input-group"> <span class="input-group-addon"><img src="images/dollar-coins.png" alt="" /></span>
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           <div class="input-group">
                              <span class="input-group-addon"><img src="images/percentage.png" alt="" height="10"/></span>
