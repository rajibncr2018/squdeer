               ...
               <div class="col-md-12">
                  <div class="custm-linkedt">
                     <ul>
                        ...
                        <li><a href="#"  data-toggle="tooltip" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i> </a></li>
                     </ul>
                  </div>
                  <div class="staff-detailuser">
                     <img src="images/noimage.png" class="img-circle" alt="" width="55" height="55">
                     <h4>Jason <a href="#" style="font-size: 14px; margin-left: 10px; font-weight: 300;"  data-toggle="tooltip" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i> </a></h4>
                              ...
                              <ul>
                                 ...
                                 <li>
                                    <div class="row">
                                       ...
                                       <div class="col-sm-2">
                                          <button type="button" class="btn btn-sm btn-toggle pull-right active" data-toggle="button" aria-pressed="true" autocomplete="off">
                                 ...
                                 <li>
                                    <div class="row">
                                       ...
                                       <div class="col-sm-2">
                                          <button type="button" class="btn btn-sm btn-secondary btn-toggle pull-right" data-toggle="button" aria-pressed="false" autocomplete="off">
                                             <div class="handle"></div>
                                          </button>
                                       </div>
                                    </div>
                                 ...
                                 <li>
                                    <div class="row">
                                       <div class="col-sm-10">
                                          ...
                                          <p>lamie74@gmail.com <span class="label label-danger"><i>Not Verified</i></span></p>
                                       </div>
                                       <div class="col-sm-2">
