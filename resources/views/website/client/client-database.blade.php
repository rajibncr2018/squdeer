      ...
      <div class="upper-cmnsection">
        ...
        <div class="leftpan">
            <div class="left-menu">
                ...
                ?>
                    <a href="javascript:void(0);" class="clientlistitem" data-json='<?php echo str_replace("'",'',json_encode($client));?>'>
                ...
                <div class="col-lg-12">
                    <form>
                        ...
                        <div class="headRow cdHeadbar">
                            ...
                            <img id="clientImg" src="" class="img-circle" alt="" width="55" height="55">
...
@section('custom_js')
<script>
$('.clientlistitem').click(function(){
    $('.clientlistitem').removeClass('active');
...
$(document).ready(function(){
    $('.clientlistitem').eq(0).trigger('click');
});
</script>
@endsection