      ...
      <div class="span12">
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{ url('admin/modify-category') }}" name="basic_validate" id="basic_validate" novalidate="novalidate">
              <input type="hidden" name="category_id" value="<?=isset($result->category_id) && $result->category_id ? $result->category_id : ''; ?>">
              <div class="control-group">
                <label class="control-label">Category</label>
                <div class="controls">
                  <input type="text" name="category" id="" required="" value="<?=isset($result->category) && $result->category ? $result->category : ''; ?>">
                </div>
              </div>
