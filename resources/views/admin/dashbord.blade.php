...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class=""><a title="" href="{{url('login')}}"><i class="icon icon-share-alt"></i> <span class="text">Logout</span></a></li>
  </ul>
</div>

<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    <li class="active"><a href="{{asset('admin-dashboard')}}"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
...
<div class="row-fluid">
  <div id="footer" class="span12"> 2013 &copy; Matrix Admin. Brought to you by <a href="http://{{asset('')}}">Themedesigner.in</a> </div>
</div>
