              ...
              <div class="noti">
                  ...
                  <div class="notify" >
                   ...
                   <!-- <a href="#" class="flip"><img src="images/arrow.png" alt=""/></a>-->
                    ...
                    <a onClick="slideDiv(this);" data-toggle="collapse" data-parent="#accordion" href="#collapse2" style="cursor: pointer;">

                    <b class="fa fa-custom fa-caret-down show-arrow" ></b></a>
                  ...
                  <div class="notify" >
                    ...
                    <!-- <a href="#" class="flip"><img src="images/arrow.png" alt=""/></a>-->
                     ...
                     <a onClick="slideDiv(this);" data-toggle="collapse" data-parent="#accordion" href="#collapse1" style="cursor: pointer;">
                      ...
                      <h2 class="app-update">Update <img src="{{asset('public/assets/website/images/icon-squeedr.png')}}"></h2>  
                         ...
                         <div class="feedb">
                          ...
                          <div class="feedb-list">                                     
                                 ...
                                 <p> <strong>Tell About App</strong><br>

                                   You have listed your job! Now add a profile photo to help others recognize you.</p>
                    ...
                    <div class="noti">
                        ...
                        <div class="feedb">
                            ...
                            <div class="feedb-list">
                                    ...
                                    <span class="tt">25h</span>

                                <img src="{{asset('public/assets/website/images/user-img.png')}}">

                                <p>    <strong>Steph Pouyet</strong><br>                

                                   Congratulate Robin Wethll and 2 others for starting new Positions<br>
                     ...
                     <div class='col-sm-6'>
                        ...
                        <div class="form-group">
                           ...
                           <div class="input-group"> <span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
                              ...
                              <input id="startdate" type="text" class="form-control" name="startdate" placeholder="Start Time">
                     ...
                     <div class='col-sm-6'>
                        ...
                        <div class="form-group">
                           ...
                           <div class="input-group"> <span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
                              ...
                              <input id="enddate" type="text" class="form-control" name="enddate" placeholder="End Time">
